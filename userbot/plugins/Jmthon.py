...
USER_BOT_WARN_ZERO = " لقد حذرتك من الـتكرار العشوائي/n الآن تم حظرك والإبلاغ عنك حتى إشعار آخر. \n\n**وداعاَ** "
...
if Config.PRIVATE_GROUP_ID is not None:
    ...
    @bot.on(admin_cmd(pattern="الغاء البلوك(?: |$)(.*)"))
    ...
    async def do_pm_permit_action(chat_id, event, sender):
        ...
        if PMMENU:
            if Config.CUSTOM_PMPERMIT_TEXT:
                ...
                USER_BOT_NO_WARN = (
                    f"𝑱𝑀𝑇𝐻𝑂𝑁 𝑺𝑂𝑈𝑅𝐶𝐸 \n𓍹ⵧⵧⵧⵧⵧⵧⵧⵧⵧⵧⵧⵧⵧⵧⵧⵧⵧⵧⵧⵧⵧⵧⵧ𓍻\nهلا  {mention}\n  لم تتم الموافقه على ارسال الرسائل ، لا ترسل الكثير من الرسائل هنا سيتم حظرك   |  رد تلـقائي."
                    f"فقط قل سبب مجيئك ونتظر حته اعود لكي تتم الموافقه عليك.\
                                    \n ⤶ ❨ **عندك** {warns}/{totalwarns} **تحذيرات** ❩\n𓍹ⵧⵧⵧⵧⵧⵧⵧⵧⵧⵧⵧⵧⵧⵧⵧⵧⵧⵧⵧⵧⵧⵧⵧⵧ𓍻"
                )
        else:
            if Config.CUSTOM_PMPERMIT_TEXT:
                USER_BOT_NO_WARN = Config.CUSTOM_PMPERMIT_TEXT.format(
                ...
                USER_BOT_NO_WARN = (
                    f"𝑱𝑀𝑇𝐻𝑂𝑁 𝑺𝑂𝑈𝑅𝐶𝐸 \n𓍹ⵧⵧⵧⵧⵧⵧⵧⵧⵧⵧⵧⵧⵧⵧⵧⵧ𓍻\nهلا  {mention}⌁ لم تتم الموافقه على ارسال الرسائل ، لا ترسل الكثير من الرسائل هنا سيتم حظرك   |  رد تلـقائي."
                    f"فقط قل سبب مجيئك ونتظر حته اعود لكي تتم الموافقه عليك.\
                                    \n ⤶ ❨ **لـديك** {warns}/{totalwarns} **تحذيرات** ❩\n𓍹ⵧⵧⵧⵧⵧⵧⵧⵧ⁦⁦ⵧⵧⵧⵧⵧⵧⵧⵧ𓍻"
                )
        if PMPERMIT_PIC:
...
async def hehehe(event):
    ...
    if event.is_private:
        if not pmpermit_sql.is_approved(chat.id):
            ...
            await borg.send_message(chat, "** أنـه مطـور الـسورس الخـاص بـك مـحمد **")
