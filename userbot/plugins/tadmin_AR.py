...
async def tmuter(catty):
    ...
    if reason:
        ...
        await catevent.edit("اذا لـم تكن لديـك اي معـلومه عن الكـتم مؤقت ارسـل أمـر `.info tadmin` ⌁")
        return
    ...
    if user.id == self_user.id:
        await catevent.edit(f"عـتذر لايمكنـني الكـتم ⌁")
        return
    try:
